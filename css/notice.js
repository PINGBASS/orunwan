...
const idea=document.getElementsByClassName('noticemodal1');
const idea2=document.getElementsByClassName('noticemodal2');
const idea3=document.getElementsByClassName('noticemodal3');
const idea4=document.getElementsByClassName('noticemodal4');
